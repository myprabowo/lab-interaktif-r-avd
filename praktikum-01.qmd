...
- Operasi sederhana (aritmetika & fungsi dasar)
- Jenis-jenis variabel dan tipe data di R
- Analisis statistik sederhana (vektor dan data frame)
- Pembuatan grafik dasar dengan `plot()`
